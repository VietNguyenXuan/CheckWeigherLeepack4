...
namespace CodeVendor.Controls
{
    ...
    private bool IsActiveMoving = false;
		#endregion
		...
		public Grouper()
		{
			InitializeStyles();
			InitializeGroupBox();
      this.MouseDown +=new MouseEventHandler(Grouper_MouseDown);
      this.MouseUp += new MouseEventHandler(Grouper_MouseUp);
      this.MouseMove += new MouseEventHandler(Grouper_MouseMove);
		}
    ...
    private void Grouper_MouseDown(object sender, MouseEventArgs e)
    {
      if (IsActiveMoving == true)
      {
        mouseClicked = true;
    ...
    private void Grouper_MouseUp(object sender, MouseEventArgs e)
    {
      mouseClicked = false;
    }

    private void Grouper_MouseMove(object sender, MouseEventArgs e)
    {
      if (mouseClicked)
      {
