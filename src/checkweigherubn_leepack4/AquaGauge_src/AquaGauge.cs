...
namespace AquaControls
{
    ...
    public partial class AquaGauge : UserControl
    {
        ...
        private void DisplayNumber(Graphics g, float number, RectangleF drect)
        {
            try
            {
                string num = number.ToString("00.000");
        ...
        private void AquaGauge_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void AquaGauge_MouseUp(object sender, MouseEventArgs e)
        {
          mouseClicked = false;
        }

        private void AquaGauge_MouseMove(object sender, MouseEventArgs e)
        {
          if (mouseClicked)
          {
