...
namespace GlacialComponents.Controls
{
    ...
    private bool                m_bDisplayProgressbar = false;
    private bool               m_bCheckBoxeReadonly = false;
    ...
    private GLActivatedEmbeddedTypes    m_ActivatedEmbeddedPreviousType = GLActivatedEmbeddedTypes.None;
    ...
    public GLActivatedEmbeddedTypes GLActivatedEmbeddePreviousTypes 
    {
      get
      {
        return m_ActivatedEmbeddedPreviousType;
      }
      set
      {
        // set the activated embedded control template here
        m_ActivatedEmbeddedPreviousType = value;
      }
    }
    /// <summary>
    /// Type of activated embedded control to use
    ...
    [
		...
		public GLActivatedEmbeddedTypes ActivatedEmbeddedType
		{
			...
			set
			{
				...
				else if ( value == GLActivatedEmbeddedTypes.ProgressBar )
				{
					this.ActivatedEmbeddedControlTemplate = new GLProgressBar();
				}
    ...
    /// </summary>
    [
    Description("Enable context nenu with this columns"),
    Category("Behavior"),
    Browsable(true)
    ]
    ...
    /// <summary>
		...
		/// </summary>
		[
    Description("Whether or not procressbar are visible in this column."),
    Category("Behavior"),
    Browsable(true)
    ]
    public bool DisplayProgressBar
    {
      get { return m_bDisplayProgressbar; }
      set { m_bDisplayProgressbar = value; }
    }
    ...
    /// <summary>
		...
		/// </summary>
		[
    Description("checkboxes is Readonly mode or not "),
    Category("Behavior"),
    Browsable(true)
    ]
    public bool CheckBoxesReadOnly
    {
      get { return m_bCheckBoxeReadonly; }
      set { m_bCheckBoxeReadonly = value; }
    }
