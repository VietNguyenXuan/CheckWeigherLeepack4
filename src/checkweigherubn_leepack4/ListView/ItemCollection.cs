...
namespace GlacialComponents.Controls
{
    ...
    private int           m_ProgresBarPercent = 0;
    ...
    private bool m_bEnableContextMenu = false;
		...
		public bool Checked
		{
          ...
          {
            //SelectionChanged
            ChangedEvent(this, new ChangedEventArgs(ChangedTypes.SelectionChanged, null, null, this));
          }
          ...
          if (ChangedEvent != null)
          {
            ChangedEvent(this, new ChangedEventArgs(ChangedTypes.CheckedChanged, null, null, this));
          }
				}
			}
		}
    ...
    private bool m_ActiveHightlightColor;
    /// <summary>
    /// Text color for item
    /// </summary>
    //[
    ...
    //  Browsable(true)
    //  ]
    public bool ActiveHightlightColor
    {
      get { return m_ActiveHightlightColor; }
      set { m_ActiveHightlightColor = value; }
    }

    public int ProgresBarPercent
    {
      get { return m_ProgresBarPercent; }
      set { m_ProgresBarPercent = value; }
    }
    // m_ProgresBarPercent
    /// <summary>
    /// Text
    ...
    /// <summary>
    /// Enable context nenu with this columns
    /// </summary>
    [
